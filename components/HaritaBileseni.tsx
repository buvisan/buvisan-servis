...
const redPulseIcon = new L.Icon({
    ...
    popupAnchor: [1, -34],
    shadowSize: [41, 41],
    className: 'yanip-sonen-pin' // CSS'deki animasyonu tetikler
});
    ...
    return (
        ...
        >
            ...
            {vincler.map((vinc: any) => {
                // --- MANTIK: AKTİF ARIZA VAR MI? ---
                // service_tickets dizisinde 'tamamlandi' OLMAYAN bir kayıt var mı?
                ...
                return (vinc.lat && vinc.lng) && (
                    <Marker 
                        ...
                        // Arıza varsa Kırmızı, yoksa Yeşil ikon
